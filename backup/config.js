...
const CONFIG = {
    ...
    ADVANCED: {
        // MediaPipe 資源載入 URL
        MEDIAPIPE_BASE_URL: 'https://cdn.jsdelivr.net/npm/@mediapipe/face_detection/',
...
function autoAdjustConfig() {
    ...
    if (isMobile) {
        ...
        CONFIG.DETECTION_AREA.RADIUS = Math.max(0.40, CONFIG.DETECTION_AREA.RADIUS * 0.9);
    }
...
function validateConfig() {
    ...
    // 檢查數值範圍
    if (CONFIG.FACE_DETECTION.MIN_DETECTION_CONFIDENCE < 0 || CONFIG.FACE_DETECTION.MIN_DETECTION_CONFIDENCE > 1) {
